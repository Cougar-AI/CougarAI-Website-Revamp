...
@discord_bp.route("/config/<string:guild_id>", methods=["POST", "OPTIONS"])
@require_admin
...
@discord_bp.route("/config/<string:guild_id>", methods=["PATCH", "OPTIONS"])
@require_admin
...
@discord_bp.route("/config/<string:guild_id>", methods=["DELETE", "OPTIONS"])
@require_admin
