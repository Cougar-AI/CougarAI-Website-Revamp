...
def db_session(app):
    ...
    with app.app_context():
        ...
        # Initialize our custom tables that aren't managed by SQLAlchemy
        try:
            from app.db_init import init_database
            init_database()
        except Exception as e:
            app.logger.warning(f"Could not initialize custom tables: {e}")
            # For tests, we'll try to create the table manually
            ...
            try:
                ...
                app.logger.warning(f"Manual table creation also failed: {inner_e}")
